...
# Example toolchain for building HoneyTea on macOS with clang targeting
# Raspberry Pi OS 64-bit or another aarch64 Linux distribution.
#
# Usage:
#   cp toolchains/rpi-aarch64-clang-toolchain.example.cmake \
#      toolchains/rpi-aarch64-clang-toolchain.local.cmake
...
set(TARGET_TRIPLE "aarch64-linux-gnu" CACHE STRING "Target triple")
set(TOOLCHAIN_ROOT "/opt/llvm-cross" CACHE PATH "Directory containing clang, clang++, llvm-ar, llvm-ranlib")
set(TARGET_SYSROOT "/opt/sysroots/raspi-bookworm-arm64" CACHE PATH "Target sysroot directory")
...
set(ENV{PKG_CONFIG_LIBDIR} "${TARGET_SYSROOT}/usr/lib/${TARGET_TRIPLE}/pkgconfig:${TARGET_SYSROOT}/usr/lib/pkgconfig:${TARGET_SYSROOT}/usr/share/pkgconfig")
